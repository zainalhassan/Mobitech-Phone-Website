...
{
    echo <<<_END
        <h2 class = "header1"> Top Accessories for you - {$_SESSION['username']}</h2>
_END;
}
else
{
    echo <<<_END
        <h2 class="header1"> View a list of accessories </h2>
_END;
}
$getPhonesQuery = "SELECT * FROM products WHERE categoryID = '3';";
