...
elseif (isset($_POST['username']))
{
    ...
    if ($errors == "")
    {
        ...
        $query = "SELECT * FROM users WHERE usersUsername = '$username' AND usersPassword = '$password'";
...
//            $message = "Hi, $username, you have successfully logged in, please <a href='welcome.php'>click here</a><br>";
            header('Location: /PhoneWebsite/welcome.php');
            exit();
        }
        else
        {
        ...
        <div class = "signInBox">
            ...
            <form action="signIn.php" method="post">
                <div class = "textBox">
                    ...
                    <input type="text" name="username" maxlength="16" value="$username" placeholder = "Username" required> $username_val
                </div>
                <div class = "textBox">
                    <i class="fas fa-lock"></i>
                    <input type="password" name="password" maxlength="16" value="$password" placeholder = "Password" required> $password_val
                </div>
                <button class="mybtn button-fill-bottom"> Sign in </button>
            </form>
        </div>        
_END;
}
